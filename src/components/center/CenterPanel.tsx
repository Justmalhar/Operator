...
export const CenterPanel = forwardRef<CenterPanelHandle, CenterPanelProps>(
  function CenterPanel({ workspaceId }, ref) {
    ...
    return (
      <div className="vscode-editor flex h-full flex-col">
          ...
          <ScrollArea className="h-full w-full whitespace-nowrap">
            <div className="flex h-[35px] min-w-full items-stretch">
              {tabs.map((tab) => {
                ...
                return (
                  <div
                    key={tab.id}
                    className={cn(
                      "vscode-tab group flex h-full min-w-[100px] max-w-[180px] cursor-pointer items-center gap-1.5 px-3 text-[12px] transition-colors duration-75",
                      isActive && "active",
                    )}
              ...
              <button
                ...
                className="flex h-full w-[32px] shrink-0 items-center justify-center transition-colors duration-75 hover:bg-white/5"
